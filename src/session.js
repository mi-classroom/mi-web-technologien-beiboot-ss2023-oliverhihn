  ...
  return new Promise((resolve, reject) => {
    navigator.xr.isSessionSupported("immersive-ar").then((supported) => {
      if (supported) {
        ...
        xrButton.innerHTML = "AR nicht unterstützt";
      }
    });
  });
}
...
export function onButtonClicked() {
  if (!xrSession) {
    console.log("no xrSession going in now");
    navigator.xr
...
export async function shutdownXR() {
  if (xrSession) {
    console.log("waiting for session to end");
    console.log(await session.end());
    console.log(await xrSession.end());
    console.log(await navigator.xr.scene.end());
    console.log(await navigator.xr.session.end());
