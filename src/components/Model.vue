<template>
  <div class="bg-white">
    <div
      class="h-full border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200"
    >
      <div class="h-40">
        <img
          class="object-cover shadow-lg rounded-t-lg"
          :src="'/assets/models/' + model.image"
          :alt="model.name + 'image'"
        />
      </div>
      <div
        @click.stop="prepareModelToDrop"
        class="flex justify-between pt-12 pb-4 px-2"
      >
