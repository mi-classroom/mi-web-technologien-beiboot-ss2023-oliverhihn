<template>
  <div id="app">
    <HeaderComponent title="ARlebnispfad wählen" back-button-link="/browse" />
    <PointComponent title="Wiehl" :distance=this.calculateDistanceWiehl() />
    <PointComponent title="Straße der Arbeit - Marienheide" :distance=calculateDistanceMarienheide() />
    <PointComponent title="Wipperfürth" :distance=calculateDistanceWipperfuerth() />
  </div>
</template>
